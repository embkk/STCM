...
add wave -noupdate /top_tb/bit_population_counter_bus/srst_i

add wave -noupdate -divider "=== INPUTS ==="
add wave -noupdate -expand -group "DUT_IN" /top_tb/bit_population_counter_bus/data_i
add wave -noupdate -expand -group "DUT_IN" /top_tb/bit_population_counter_bus/data_val_i
